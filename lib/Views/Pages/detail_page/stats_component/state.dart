...
Color _anilistColors(int score) {
  switch (score) {
    case 10:
      return const Color(0xffd2492d);
    case 20:
      return const Color(0xffd3642c);
    case 30:
      return const Color(0xffd2802a);
    case 40:
      return const Color(0xffcd9c2c);
    case 50:
      return const Color(0xffd1b82a);
    case 60:
      return const Color(0xffd2d12c);
    case 70:
      return const Color(0xffb7d22f);
    case 80:
      return const Color(0xff9cd12d);
    case 90:
      return const Color(0xff81d02c);
    case 100:
      return const Color(0xff66d12f);
    default:
      return const Color(0xff424141);
  }
}
...
Color _anilistStatusMapper(String status) {
  switch (status) {
    case 'COMPLETED':
      return const Color(0xff67D639);
    case 'PLANNING':
      return const Color(0xff01a9fe);
    case 'CURRENT':
      return const Color(0xff9156f2);
    case 'PAUSED':
      return const Color(0xfff879a4);
    case 'DROPPED':
      return const Color(0xffe75d74);
    default:
      return Colors.grey;
  }
}
